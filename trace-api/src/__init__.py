...
from .api import web_auth, web_session, api_user, api_role, api_project, api_haz, api_rcm, api_cst, api_product, \
    ...
    api_project_member, api_project_timeline, api_prod_runtime_env, api_prod_device_res, api_prod_hospital, api_prod_algo_module, api_prod_algo_chapter, api_pdp_doc, api_pir_doc, \
...
def create_app():
    ...
    main_router.include_router(api_prod_algo_module.router, prefix="/prod_algo_module", tags=["导航模块"])
    main_router.include_router(api_prod_algo_chapter.router, prefix="/prod_algo_chapter", tags=["章节模块"])
