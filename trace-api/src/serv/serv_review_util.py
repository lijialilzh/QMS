...
COVER_KEYWORDS = {
    ...
    "dd_009_01": ["数据标注记录", "肺栓塞分诊标注记录"],
    "dd_009_02": ["数据标注记录", "肺叶分割标注记录"],
    "dd_009_03": ["数据标注记录", "肺栓塞分诊评测记录"],
    "dd_010": ["数据库上传记录"],
    "dd_011": ["数据标注需求反馈"],
    "dd_012": ["查重记录", "训练集测试集查重"],
    "dd_013_01": ["人员初次考核评价记录-肺栓塞分割/分诊", "初次考核评价记录-肺栓塞"],
    "dd_013_02": ["人员初次考核评价记录-肺叶分割", "初次考核评价记录-肺叶"],
    "dd_013_03": ["人员定期考核评价记录-肺栓塞分割/分诊", "定期考核评价记录-肺栓塞"],
    "dd_013_04": ["人员定期考核评价记录-肺叶分割", "定期考核评价记录-肺叶"],
