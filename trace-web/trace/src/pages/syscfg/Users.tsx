...
const PREVIEW_MODULES = [
    ...
    { name: "产品管理", match: (code: string) => code.startsWith("product") || code.startsWith("prod_haz") || code.startsWith("prod_rcm") || code.startsWith("prod_cst") || ["project_member", "project_timeline", "prod_runtime", "prod_device"].some((k) => code.startsWith(k)) },
    { name: "产品文件管理", match: (code: string) => code.startsWith("srs_doc") || code.startsWith("pdp_doc") || code.startsWith("pir_doc") || code.startsWith("acc_doc") || code.startsWith("release_note") || code.startsWith("vuh_doc") || code.startsWith("ptr_doc") || code.startsWith("research_doc") || code.startsWith("rmp_doc") || code.startsWith("pha_doc") || code.startsWith("nsr_doc") || code.startsWith("cyber_cap_doc") || code.startsWith("label_doc") || code.startsWith("nsmp_doc") || code.startsWith("risk_mgmt_doc") || code.startsWith("ftr_record_doc") || code.startsWith("prod_dhf") },
