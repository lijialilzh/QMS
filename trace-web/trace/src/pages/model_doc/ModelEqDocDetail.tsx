...
export default () => {
    ...
    const title = getModelDocMeta(type).title;
    ...
    const cols = rows.reduce((m, r) => Math.max(m, r.length), 0) || 10;
        ...
        <div className="div-v page pdp-detail">
            ...
            <Spin spinning={data.loading} wrapperClassName="pdp-scroll">
                <div style={{ height: "100%", overflow: "auto" }}>
                    <div style={{ padding: "12px 20px", maxWidth: 1280 }}>
                        <div style={{ textAlign: "center", fontSize: 16, fontWeight: 700, margin: "4px 0 6px" }}>{title}</div>
