import { Button, Table, message, Modal, Select, Input, Tag, Space } from "antd";
...
export default () => {
    ...
    const doSearch = (pageIndex: any, pageSize: any) => {
        ...
        Api.list_prod_haz({ prod_id: prodId, page_index: pageIndex - 1, page_size: pageSize }).then((res: any) => {
                    ...
                    <div className="prod-dhf-product-select">
                        <ProductVersionSelect
                            ...
                            onChange={(value?: number) => {
                                ...
                                navigate(`/prod_hazs/${readOnly ? "view" : "edit"}/${value}`);
                            }}
                        />
                    </div>
                    ...
                    <div className="div-h hspace">
                        <Button
                            ...
                            onClick={() => {
                                ...
                                Api.export_prod_hazs({ prod_id: prodId, page_index: 0, page_size: 2000 }).then((res: any) => {
