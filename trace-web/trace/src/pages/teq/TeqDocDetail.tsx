...
export default () => {
    ...
    const load = () => {
        ...
        Api.get_teq_doc({ id }).then((res: any) => {
    ...
    const addRow = () => {
        ...
        const seq = String(next.rows.length);
    ...
    const doSave = () => {
        ...
        Api.update_teq_doc({ id, content: data.content, product_id: data.doc.product_id, version: data.doc.version }).then((res: any) => {
    ...
    const doExport = async () => {
        ...
        try {
            const res: any = await Api.export_teq_doc({ id });
        ...
        <div className="div-v page pdp-detail">
            <div className="div-h pdp-toolbar">
                ...
                <Space>
                    ...
                    <Button onClick={() => navigate("/teq_docs")}>{ts("back")}</Button>
                </Space>
            </div>
            ...
            <Spin spinning={data.loading} wrapperClassName="pdp-scroll">
                <div style={{ height: "100%", overflow: "auto" }}>
                    <div style={{ padding: "12px 20px", maxWidth: 1200 }}>
                        <div style={{ textAlign: "center", fontSize: 16, fontWeight: 700, margin: "4px 0 6px" }}>测试设备清单</div>
